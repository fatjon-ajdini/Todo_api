...
all_todos = [
    ...
    Todo(todo_id=2, todo_name="Library", todo_description="Borrow the book", priority=Priority.MEDIUM),
    Todo(todo_id=3, todo_name="Cook", todo_description="Cook dinner", priority=Priority.LOW),
    Todo(todo_id=4, todo_name="Work", todo_description="9Am - 5PM", priority=Priority.MEDIUM),
    Todo(todo_id=4, todo_name="Study", todo_description="For Biology", priority=Priority.LOW),
]
